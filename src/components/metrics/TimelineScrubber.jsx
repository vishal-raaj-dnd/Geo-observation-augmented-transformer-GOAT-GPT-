...
export default function TimelineScrubber({ onDayChange }) {
  const days = [
    { label: "T-3 Days", date: "2026-08-17", status: "Pre-event baseline capture" },
    { label: "T-2 Days", date: "2026-08-18", status: "Rainfall initiation satellite pass" },
    { label: "T-1 Day", date: "2026-08-19", status: "Peak surge onset capture" },
    { label: "Today (T0)", date: "2026-08-20", status: "Max inundation multi-spectral pass" }
  ];
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          <div>
            ...
            <div style={{ fontSize: 11, color: '#94a3b8' }}>
              {currentDay.label} ({currentDay.date}) — {currentDay.status}
            </div>
          </div>
        </div>
