"""
===================================================================================
DRISHTI Earth Observation — Pan-India Unbiased QLoRA Fine-Tuning Pipeline
Base Model: Qwen/Qwen2.5-7B-Instruct (4-bit NF4 Quantization)
Target GPU: Kaggle GPU (Tesla T4 16GB VRAM) / Google Colab / Local NVIDIA GPU
Includes Pre-Import Auto-Docstring & Dataclass Monkey-Patches for Kaggle Python 3.12
===================================================================================
"""
...
# ---------------------------------------------------------------------------------
# STEP 0: PRE-IMPORT MONKEY-PATCH TRANSFORMERS AUTO-DOCSTRING & DATACLASS ON KAGGLE
# ---------------------------------------------------------------------------------
try:
...
# NOW IMPORT TRANSFORMERS MODEL CLASSES
from datasets import load_dataset
from transformers import AutoModelForCausalLM, AutoTokenizer, BitsAndBytesConfig
from peft import LoraConfig, get_peft_model, prepare_model_for_kbit_training

DATASET_PATH = "pan_india_unbiased_eo_dataset.jsonl"
OUTPUT_DIR = "./drishti_qwen2.5_pan_india_adapter"
MODEL_ID = "Qwen/Qwen2.5-7B-Instruct"  # Production 7B Vision Grounding Model
TOTAL_SAMPLES = 5000

# ---------------------------------------------------------------------------------
# STEP 1: INLINE PAN-INDIA UNBIASED DATASET GENERATOR (ALL 15 AGRO-CLIMATIC ZONES)
# ---------------------------------------------------------------------------------
AGRO_CLIMATIC_ZONES = [
    {
